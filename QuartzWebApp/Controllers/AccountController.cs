    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var basicAccuracy = (int)SchedAccuracy.BasicAccuracy;
                ...
                if (result.Succeeded)
                {
                    ...
                    //find user by id and assign schedAccuracy to this field..

                    var userId = User.Identity.GetUserId();

                    ScheduleEntity db = new ScheduleEntity();

                    db.AspNetUsers.Where(x => x.Id == user.Id).First().SchedAccuracy = basicAccuracy;
